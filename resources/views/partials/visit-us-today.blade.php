<section class="visit-us-today section section-alt">
  <div class="container">
    ...
    <div class="visit-us-grid">
      <div class="visit-map-card">
        <iframe
          title="Sheepshead Bay office map"
          src="https://maps.google.com/maps?q=2657+Batchelder+St,+Brooklyn,+NY+11235&output=embed"
          loading="lazy"
          referrerpolicy="no-referrer-when-downgrade"
        ></iframe>
        <div class="visit-map-body">
          <h3>Sheepshead Bay Office</h3>
          <p>2657 Batchelder Street, 1st Floor<br>Brooklyn, NY 11235</p>
          <p><strong>Phone:</strong> <a href="tel:7183323401">718-332-3401</a><br>
             <strong>Fax:</strong> 646-719-8631</p>
        </div>
      </div>
