...
<nav class="footer-nav" aria-label="Footer navigation">
  <div class="container footer-nav-inner">
    ...
    <a href="{{ route('locations') }}">Locations &amp; Hours</a>
  ...
  <div class="container">
    <div class="footer-main">
      <div class="footer-brand-block">
        ...
        <p class="footer-tagline">We treat you like family.</p>
      </div>

      <div class="footer-locations">
        <div class="footer-location">
          <h4>Sheepshead Bay Office</h4>
          <p>
            2657 Batchelder Street, 1st Floor<br>
            Brooklyn, NY 11235
          </p>
          <p>
      ...
      <div class="footer-social-block">
        ...
        <a href="{{ route('contact') }}" class="footer-email-link">info@integratedrehabandphysicaltherapy.com</a>
      </div>
    </div>

    <div class="footer-bottom">
      <span>&copy; 2018-{{ date('Y') }} Integrated Rehab and Physical Therapy P.C. All Rights Reserved.</span>
